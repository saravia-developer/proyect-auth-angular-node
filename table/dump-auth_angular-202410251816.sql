...
CREATE TABLE `fileData` (
  ...
  `data` text COMMENT 'Esta columna fue creada para guardar todos los datos que se ingresan al input de la página "table" del frontend',
  PRIMARY KEY (`id`),
  UNIQUE KEY `fileData_UN` (`name`)
...
--
-- Dumping routines for database 'auth_angular'
--
...
-- Dump completed on 2024-10-25 18:16:24
